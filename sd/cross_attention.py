...
class CrossAttention(nn.Module):
    def __init__(self, n_heads, d_embed, d_cross):
        super().__init__()
        self.cross_attn_q = nn.Linear(d_embed, d_embed, bias=False)
        self.cross_attn_k = nn.Linear(d_cross, d_embed, bias=False)
        self.cross_attn_v = nn.Linear(d_cross, d_embed, bias=False)
